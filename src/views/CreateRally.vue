        ...
        <div class="register_container">
            ...
            <el-form :model="createRally" :rules="rules" ref="ref_form">
                ...
                <el-form-item prop="album">
                    <el-input v-model="createRally.album" placeholder="Photo Album URL" clearable>
                        <template #prepend>
...
const rules = {
  ...
  mapUrl:[{required: 'true', trigger: 'blur', message: 'Please Insert Google Map URL'}],
...
const getRallyData = async() => {
  ...
  formData.append('album', createRally.album);
